...
import torch
from ..tools import sum_except_batch
...
class CPABCouplingTransform(PiecewiseCouplingTransform):
    """
    Reference:
    ...
    def __init__(
        ...
        if apply_unconditional_transform:
            unconditional_transform = lambda features: ContinuousPiecewiseAffineCDF(
    ...
    def _transform_dim_multiplier(self): # define the output parameters size of NN
            return self.num_bins - 1

    def _piecewise_cdf(self, inputs, transform_params,inverse=False):
        unnormalized_theta = transform_params # (256,392,8)
